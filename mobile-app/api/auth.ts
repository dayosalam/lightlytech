...
// API base URL - using your actual Wi-Fi IP address
const API_URL = "http://192.168.0.185:3003/api";
...
export const signIn = async (email: string, password: string) => {
  try {
    ...
    if (error.message.includes('Network') || error.message.includes('fetch')) {
      ...
      console.error("3. Are you testing on an emulator? Try using your actual IP address");
